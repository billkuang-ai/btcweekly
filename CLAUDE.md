...
2. **Shortlist** — Present 5 candidates to Bill. Wait for his selection before writing.
3. **Draft** — Write the approved stories following all item format and editorial standards below.
...
Bill will select up to 3. A week with 1 exceptional story runs as 1. Wait for his approval before writing.
